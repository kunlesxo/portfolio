...
/* ─── Same deterministic UUID fn as Ticket.jsx ─── */
const mkUUID = (seed) => {
  let h = 0;
...
/* ─── Pre-computed UUIDs — identical seeds to Ticket.jsx ─── */
const EVENT_UUIDS = {
...
const SOCIALS = [
  { icon: "facebook",  label: "Facebook",    color: "#1877F2", href: "https://www.facebook.com/p/Kng-Ego-61577571745058/", svg: <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg> },
  { icon: "instagram", label: "Instagram", color: "#E1306C", href: "https://www.instagram.com/iamkngego/?hl=en", svg: <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg> },
  { icon: "twitter",   label: "X / Twitter", color: "#fff",    href: "https://www.x.com", svg: <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.737-8.835L1.254 2.25H8.08l4.259 5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> },
  { icon: "tiktok",    label: "TikTok",      color: "#69C9D0", href: "https://www.tiktok.com/@iamkngego?lang=en", svg: <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.75a8.16 8.16 0 004.77 1.52V6.82a4.85 4.85 0 01-1-.13z"/></svg> },
  { icon: "youtube",   label: "YouTube",     color: "#FF0000", href: "https://www.youtube.com/channel/UCD4ESXQlGLwZzDxr7ob0-Uw", svg: <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg> },
  { icon: "spotify",   label: "Spotify",     color: "#1DB954", href: "https://open.spotify.com/artist/6UnDrbP3SceYTKa52TdXfx?si=tW44YyocS9GIEHOK4a3FzA", svg: <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg> },
];

const TOURS = [
  { id: 1, eventId: 1, date: "APR 4 2026",  title: "The Cowan",                 location: "Nashville, TN",  img: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=400&q=80" },
  { id: 2, eventId: 2, date: "APR 10 2026", title: "The Hidden Gem Music Club", location: "Dayton, OH",     img: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=400&q=80" },
  { id: 3, eventId: 3, date: "APR 11 2026", title: "Shenanigans",               location: "Portage, IN",    img: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=400&q=80" },
  { id: 4, eventId: 4, date: "APR 24 2026", title: "Gregory Lake RV Park",      location: "Drakesboro, KY", img: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=400&q=80" },
  { id: 5, eventId: 5, date: "MAY 16 2026", title: "Neon Moon Saloon",          location: "Akron, OH",      img: "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=400&q=80" },
  { id: 6, eventId: 6, date: "MAY 30 2026", title: "Mac's Bar",                 location: "Lansing, MI",    img: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=400&q=80" },
];

const ALBUMS = [
  { title: "Family Ties 2",   artist: "Kng Ego, JOYBVND",  img: Front_pics1 },
  { title: "Country Gangsta", artist: "Kng Ego",            img: Front_pics2 },
  { title: "ARIES SZN",       artist: "Kng Ego",            img: Front_pics3 },
  { title: "Made For This",   artist: "Kng Ego",            img: Front_pics4 },
  { title: "Family Ties",     artist: "Kng Ego, JOYBVND",  img: Front_pics5 },
  { title: "Enough Said",     artist: "Kng Ego",            img: Front_pics6 },
];
...
const STREAMING = [
  {
    ...
    url: "https://open.spotify.com/artist/6UnDrbP3SceYTKa52TdXfx?si=tW44YyocS9GIEHOK4a3FzA",
    svg: <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg>,
  },
  {
    name: "Apple Music",
    color: "#fc3c44",
...
function useInView() {
  ...
  useEffect(() => {
    const obs = new IntersectionObserver(([e]) => { if (e.isIntersecting) setInView(true); }, { threshold: 0.06, rootMargin: "0px 0px -40px 0px" });
...
/* ═══════════════════════════════════════════════════════════════
   STREAMING MODAL — responsive big screen + mobile
═══════════════════════════════════════════════════════════════ */
    ...
    return (
      <div
        ...
        style={{
          ...
          backdropFilter: visible ? "blur(24px)" : "blur(0)",
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative", overflow: "hidden" }}>
            ...
            />
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, transparent 60%, rgba(10,10,16,0.9))" }} />
            {/* Tag top-left */}
            <div style={{ position: "absolute", top: 16, left: 16, background: "rgba(245,166,35,0.15)", border: "1px solid rgba(245,166,35,0.4)", borderRadius: 20, padding: "4px 12px", fontSize: 10, fontWeight: 800, letterSpacing: "0.12em", color: "#F5A623", textTransform: "uppercase" }}>
              Now Playing
            </div>
          </div>

          {/* Right — info + streaming */}
          <div style={{ padding: "32px 28px 28px", display: "flex", flexDirection: "column", gap: 0 }}>
            {/* Close */}
            <button
              onClick={handleClose}
              style={{ alignSelf: "flex-end", width: 32, height: 32, borderRadius: "50%", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)", fontSize: 17, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, transition: "all 0.2s" }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: "50%", overflow: "hidden", border: "2px solid rgba(245,166,35,0.5)", flexShrink: 0 }}>
                <img src={Front_pics} alt="KNGEGO" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
              <div>
                <div style={{ fontSize: 10, color: "rgba(255,255,255,0.35)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 1 }}>Artist</div>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#fff" }}>{item.artist}</div>
              </div>
            </div>

            {/* Title */}
            <div style={{ fontSize: 26, fontWeight: 900, fontFamily: "'Syne',sans-serif", color: "#fff", lineHeight: 1.15, marginBottom: 6 }}>{item.title}</div>
            <div style={{ height: 2, width: 40, background: "linear-gradient(90deg,#F5A623,#FF6B35)", borderRadius: 1, marginBottom: 24 }} />

            {/* Label */}
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase", marginBottom: 14 }}>Listen On</div>

            {/* Streaming buttons — stacked vertically on desktop */}
            <div style={{ display: "flex", flexDirection: "column", gap: 10, flex: 1 }}>
              {STREAMING.map((s) => (
                <DesktopStreamBtn key={s.name} service={s} />
              ))}
            </div>
          </div>
        </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        backdropFilter: visible ? "blur(18px)" : "blur(0)",
    ...
    >
      ...
      >
        ...
        {/* Cover art — square full width */}
        <div style={{ margin: "16px 20px 0", borderRadius: 20, overflow: "hidden", position: "relative" }}>
          <img src={item.img} alt={item.title} style={{ width: "100%", aspectRatio: "1/1", objectFit: "cover", display: "block" }} />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top,rgba(10,10,16,0.7) 0%,transparent 50%)" }} />
          <div style={{ position: "absolute", top: 12, left: 12, background: "rgba(245,166,35,0.15)", border: "1px solid rgba(245,166,35,0.4)", borderRadius: 20, padding: "4px 12px", fontSize: 10, fontWeight: 800, letterSpacing: "0.12em", color: "#F5A623", textTransform: "uppercase" }}>
            Play Track
          </div>
        </div>
        ...
        <div style={{ padding: "20px 24px 0" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", marginTop: 3 }}>{item.artist}</div>
            </div>
          </div>
          ...
          {/* Streaming buttons */}
          <div style={{ display: "flex", flexDirection: "column", gap: 12, paddingBottom: 36 }}>
            {STREAMING.map((s) => (
              <MobileStreamBtn key={s.name} service={s} />
            ))}
          </div>
        </div>
      </div>
...
function DesktopStreamBtn({ service }) {
  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow: hov ? `0 6px 24px ${service.color}22` : "none",
        cursor: "pointer",
      }}
    >
      <div style={{ color: service.color, display: "flex", alignItems: "center", flexShrink: 0 }}>{service.svg}</div>
      <span style={{ fontSize: 15, fontWeight: 700, color: "#fff", flex: 1 }}>Listen on {service.name}</span>
      <span style={{ fontSize: 14, color: service.color, fontWeight: 700, opacity: hov ? 1 : 0.4, transition: "opacity 0.2s" }}>→</span>
    </a>
  );
}

function MobileStreamBtn({ service }) {
  const [hov, setHov] = useState(false);
  return (
    <a
      href={service.url}
...
/* ─── TOUR CARD — "GET TICKETS" routes to /tickets/event/:uuid ─── */
function TourCard({ show }) {
  const navigate = useNavigate();
  const [hov, setHov] = useState(false);
  const goTickets = (e) => {
    e.stopPropagation();
    navigate(`/tickets/event/${EVENT_UUIDS[show.eventId]}`);
  };
  return (
    <div
      onMouseEnter={() => setHov(true)}
    ...
    >
      ...
      <div style={{ padding: "12px 14px 14px" }}>
        ...
        <button
          onClick={goTickets}
          style={{ width: "100%", padding: "9px 0", borderRadius: 9, border: "1px solid rgba(245,166,35,0.5)", background: hov ? "linear-gradient(135deg,#F5A623,#FF6B35)" : "transparent", color: hov ? "#000" : "#F5A623", fontWeight: 700, fontSize: 11, letterSpacing: "0.08em", cursor: "pointer", transition: "all 0.3s" }}
        >GET TICKETS</button>
      </div>
    </div>
  );
...
function TourRow({ show }) {
  ...
  return (
    <div
      onMouseEnter={() => setHov(true)}
      onMouseLeave={() => setHov(false)}
      style={{ display: "flex", gap: 14, padding: "12px 14px", background: hov ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.03)", border: `1px solid ${hov ? "rgba(245,166,35,0.2)" : "rgba(255,255,255,0.06)"}`, borderRadius: 14, alignItems: "center", transition: "all 0.25s", cursor: "pointer" }}
      onClick={goTickets}
    >
      ...
      <button
        onClick={goTickets}
        style={{ flexShrink: 0, padding: "7px 13px", borderRadius: 8, border: "1px solid rgba(245,166,35,0.45)", background: hov ? "linear-gradient(135deg,#F5A623,#FF6B35)" : "transparent", color: hov ? "#000" : "#F5A623", fontSize: 11, fontWeight: 700, cursor: "pointer", letterSpacing: "0.05em", transition: "all 0.25s" }}
      >TICKETS</button>
    </div>
  );
}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080808", color: "#fff", fontFamily: "'DM Sans','Helvetica Neue',sans-serif", overflowX: "hidden" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media (max-width: 640px) {
          .tour-hscroll > div { width: 200px !important; }
          .media-card { width: 130px !important; }
          .media-card-img { width: 130px !important; height: 130px !important; }
        }
        @media (min-width: 769px) {
          /* Desktop streaming modal grid already handled inline */
        }
      `}</style>
      ...
      <div style={{ opacity: mounted ? 1 : 0, transition: "opacity 0.6s ease" }}>
        ...
        {/* ══ HERO ══ */}
        <div style={{ position: "relative", width: "100%", height: "100svh", minHeight: 580, maxHeight: 860, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "0 16px 30px 16px" }}>
            <h1 style={{ animation: "slideUp 0.7s ease 0.2s both", fontFamily: "'Syne',sans-serif", fontSize: "clamp(22px, 7vw, 80px)", fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1.15, marginBottom: 10, background: "linear-gradient(135deg,#fff 45%,#F5A623 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", display: "block", width: "100%" }}>
              {ARTIST.name}
            </h1>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap", animation: "slideUp 0.7s ease 0.44s both" }}>
              {SOCIALS.map((s) => (
                <a key={s.icon} href={s.href || "#"} target="_blank" rel="noopener noreferrer" title={s.label}
        ...
        {/* ══ STICKY NAV ══ */}
        <div style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(8,8,8,0.9)", backdropFilter: "blur(22px)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display: "flex", gap: 4, padding: "11px 16px", overflowX: "auto", scrollbarWidth: "none" }}>
            ...
            <button
              ...
              style={{ flexShrink: 0, marginLeft: "auto", padding: "7px 18px", borderRadius: 20, border: "1px solid rgba(245,166,35,0.5)", cursor: "pointer", fontSize: 12, fontWeight: 800, whiteSpace: "nowrap", background: "transparent", color: "#F5A623", letterSpacing: "0.06em", transition: "all 0.25s" }}
        ...
        {/* ══ TOUR ══ */}
        <section id="tour">
          <SectionHeader title="After Party Tour 2026" />
          <HScroll>
            {TOURS.map((s) => (
              <TourCard key={s.id} show={s} />
            ))}
          </HScroll>
          <div style={{ padding: "0 20px 6px", display: "flex", flexDirection: "column", gap: 10 }}>
            {TOURS.map((s) => (
              <TourRow key={s.id} show={s} />
            ))}
          </div>
        </section>
