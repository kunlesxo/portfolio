  ...
  const projects = [
    {
      ...
      image: 'https://smartcash1.vercel.app'
    },
    {
      ...
      image: 'https://pasileb.vercel.app'
    },
    {
      ...
      image: 'https://cyriox-web.vercel.app'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className={`transition-all duration-1000 ${
            ...
            <p className="text-gray-400 text-center mb-16 max-w-2xl mx-auto">
              Here are some of my recent projects that showcase my skills in backend development, frontend design, and full-stack architecture.
            </p>
              ...
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <div className={`relative group ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                    ...
                    <div className="relative bg-gray-800/50 rounded-2xl overflow-hidden border border-gray-700/50 group-hover:border-blue-500/50 transition-all duration-500">
                      <div className="aspect-video relative overflow-hidden">
                        <iframe 
                          src={project.image}
                          title={project.title}
                          className="w-full h-full border-0 pointer-events-none group-hover:scale-105 transition-transform duration-700"
                          loading="lazy"
                          onError={(e) => {
                        ...
                        />
                        <div className="hidden w-full h-full bg-gradient-to-br from-blue-600/20 to-purple-600/20 items-center justify-center absolute inset-0">
                          <div className="text-center">
                            <div className="text-6xl mb-4">🚀</div>
                            <h3 className="text-xl font-semibold text-gray-300">{project.title}</h3>
                            <p className="text-gray-400 mt-2">Live Preview</p>
                          </div>
                        </div>
                      ...
                      <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center space-x-4">
                        <a 
                          ...
                          className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-full transition-all duration-300 transform hover:scale-105 font-medium"
                        >
                        ...
                        <a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center space-x-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-full transition-all duration-300 transform hover:scale-105 font-medium"
                        >
                          <Github size={18} />
                          <span>Source</span>
                        </a>
                  ...
                  <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                    <div>
                      <h3 className="text-3xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">
                        {project.title}
                      </h3>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {project.tech.map((tech) => (
                          <span 
                            key={tech} 
                            className="px-4 py-2 bg-gradient-to-r from-blue-600/20 to-purple-600/20 text-blue-300 rounded-full text-sm font-medium border border-blue-500/20 hover:border-blue-400/50 transition-colors duration-200"
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    <div className="flex space-x-4 pt-4">
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-full transition-all duration-300 transform hover:scale-105 font-semibold shadow-lg hover:shadow-blue-500/25"
                      >
                        <ExternalLink size={18} />
                        <span>View Live</span>
                      </a>
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center space-x-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-full transition-all duration-300 transform hover:scale-105 font-semibold border border-gray-600 hover:border-gray-500"
                      >
                        <Github size={18} />
                        <span>View Code</span>
                      </a>
            ...
            <div className="text-center mt-16">
              <a 
                href="https://github.com/kunlesxo" 
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 rounded-full transition-all duration-300 transform hover:scale-105 font-semibold border border-gray-600 hover:border-blue-500/50"
              >
                <Github size={20} />
